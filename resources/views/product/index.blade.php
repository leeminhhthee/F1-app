    ...
    <!-- category-banner area start -->
		<div class="category-banner" style="background-image: url({{ asset('main_img_cate/banner2.jpg') }})">
			<div class="cat-heading">
				...
				<span style="font-size: 35px; color: black; background-color: white; border-radius: 10px; border-color: white;">{{  $cateProduct->c_name}}</span>
				@else
				<span style="font-size: 35px; color: black; background-color: white; border-radius: 10px; border-color: white;">Searching</span>
				@endif
			</div>
		</div>
					...
					<div class="col-md-12">
						<div class="container-inner">
							<ul>
								...
								@else
								<li class="category3"><span>Searching</span></li>
								@endif
							</ul>
						</div>
					</div>
